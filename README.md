...
## v0.6.0 benchmarks (single worker, loopback, 24 bundled policies)
...
docker pull ghcr.io/cloudmorphai/tessera:0.6.0
```

After install: `tessera version` prints `tessera 0.6.0`. Full install matrix + supported Python versions: [docs/INSTALL.md](docs/INSTALL.md).
