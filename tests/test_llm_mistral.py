"""Integration test for MistralPolicyAuthor.

Skips unless MISTRAL_API_KEY is set in the environment.
Run with: pytest tests/test_llm_mistral.py -v
"""
...
def test_mistral_propose_policies_basic() -> None:
    ...
    author = MistralPolicyAuthor(api_key=api_key)
